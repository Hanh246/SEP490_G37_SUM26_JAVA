...
public class AdminPayoutController {
    ...
    public ResponseEntity<BaseResponse<AdminPayoutPageResponse>> getPayouts(
        ...
        return ResponseEntity.ok(
                BaseResponse.<AdminPayoutPageResponse>builder()
                        .success(true)
                        .data(creatorPayoutService.getAdminPayouts(
                                status,
                                page,
                                size
                        ))
    ...
    @GetMapping("/settings")
    public ResponseEntity<BaseResponse<CreatorPayoutSettingsResponse>>
    getSettings() {
        return ResponseEntity.ok(
                BaseResponse.<CreatorPayoutSettingsResponse>builder()
                        .success(true)
    ...
    public ResponseEntity<BaseResponse<CreatorPayoutCurrencyResponse>>
    upsertCurrency(
            @Valid @RequestBody UpsertCreatorPayoutCurrencyRequest request
    ) {
        return ResponseEntity.ok(
                BaseResponse.<CreatorPayoutCurrencyResponse>builder()
                        .success(true)
    ...
    public ResponseEntity<BaseResponse<CreatorPayoutRequestResponse>> reject(
        ...
        return ResponseEntity.ok(
                BaseResponse.<CreatorPayoutRequestResponse>builder()
                        ...
                        .data(creatorPayoutService.reject(
                                payoutId,
                                request.getReason()
                        ))
                        .build()
