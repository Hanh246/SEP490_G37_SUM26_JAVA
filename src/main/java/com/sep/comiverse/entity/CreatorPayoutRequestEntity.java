...
public class CreatorPayoutRequestEntity extends BaseEntity {
    ...
    /** Final amount transferred by Stripe in the selected payout currency. */
    @Column(name = "amount", nullable = false, precision = 19, scale = 2)
    private BigDecimal amount;

    /** Legacy column names are retained; these snapshot values are stored in USD. */
    ...
    /**
     * Number of selected payout-currency units represented by 1 USD.
     * The legacy column name is retained to avoid a destructive migration.
     */
