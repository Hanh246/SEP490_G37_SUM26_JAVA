    ...
    private void createForumThreads() {
        if (forumThreadRepository.findAll().isEmpty()) {
            forumThreadRepository.save(ForumThreadEntity.builder()
                    .title("[ANNOUNCEMENT] ComiVerse launches offline reading feature!")
                    .author("Admin")
                    .category("News")
                    .content("We are thrilled to announce that offline reading is now available on mobile apps. Simply download your chapters and read on the go!")
                    .isPinned(true)
                    .isLocked(false)
                    .isReported(false)
                    .replies(87)
            ...
            forumThreadRepository.save(ForumThreadEntity.builder()
                    .title("Sword God Unrivaled ch.320 — that ending twist caught me off guard")
                    .author("Agatsuma_Z")
                    .category("Story Discussion")
                    .content("I can't believe the master was the traitor all along! What are your thoughts on this chapter?")
                    .isPinned(false)
                    .isLocked(false)
                    .isReported(true)
                    .reportReason("Spoilers without warning")
                    .replies(124)
                    .views(2430)
                    .build());

            forumThreadRepository.save(ForumThreadEntity.builder()
                    .title("Where to read raw chapters for free?")
                    .author("MangaFan99")
                    .category("Q&A")
                    .content("Hey guys, where can I find the raw scans without paying? The official site is locked behind coins.")
                    .isPinned(false)
                    .isLocked(false)
                    .isReported(true)
                    .reportReason("Promoting piracy")
                    .replies(9)
                    .views(180)
                    .build());

            forumThreadRepository.save(ForumThreadEntity.builder()
                    .title("Hate post against a translator group")
                    .author("StarReader")
                    .category("Site Feedback")
                    .content("The translators of Group X are terrible and lazy, they should stop scanning entirely and leave the work to others!")
                    .isPinned(false)
                    .isLocked(false)
                    .isReported(true)
            ...
            forumThreadRepository.save(ForumThreadEntity.builder()
                    .title("Top 10 best isekai of 2025 — detailed reviews for newcomers")
                    .author("OtakuViet99")
                    .category("Recommendations")
                    .content("Here is my compiled list of the must-read portal/isekai manga this year with dynamic plot analysis.")
                    .isPinned(false)
                    .isLocked(false)
                    .isReported(false)
                    .replies(56)
            ...
            forumThreadRepository.save(ForumThreadEntity.builder()
                    .title("How do I sync reading history between phone and PC?")
                    .author("newbie_123")
                    .category("Q&A")
                    .content("I am logged in on both devices but my progress on chapter 5 of Solo Leveling won't sync to my PC automatically. Help!")
                    .isPinned(false)
                    .isLocked(false)
                    .isReported(false)
                    .replies(9)
            ...
            forumThreadRepository.save(ForumThreadEntity.builder()
                    .title("[Fanart] Drew the MC from Sword God Unrivaled — feedback welcome!")
                    .author("Art_by_Linh")
                    .category("Fan Art")
                    .content("Spent 12 hours drawing this digital art piece. Let me know what you guys think about the shading and color choices!")
                    .isPinned(false)
                    .isLocked(false)
                    .isReported(false)
                    .replies(73)
            ...
            forumThreadRepository.save(ForumThreadEntity.builder()
                    .title("Feature request: highlight dialogue bubbles while reading")
                    .author("UX_Hoang")
                    .category("Site Feedback")
                    .content("It would be amazing if the comic reader could dim the background and highlight only the active dialogue text bubbles.")
                    .isPinned(false)
                    .isLocked(true)
                    .isReported(false)
                    .replies(28)
