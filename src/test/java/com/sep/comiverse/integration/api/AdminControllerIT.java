...
class AdminControllerIT extends AbstractBlackboxIT {
    ...
    @Test
    @DisplayName("TC-INT-AdminController-004")
    ...
    @Test
    @DisplayName("TC-INT-AdminController-007")
    ...
    @Test
    @DisplayName("TC-INT-AdminController-008")
    ...
    @Test
    @DisplayName("TC-INT-AdminController-009")
    ...
    @Test
    @DisplayName("TC-INT-AdminController-010")
    ...
    @Test
    @DisplayName("TC-INT-AdminController-011")
    ...
    @Test
    @DisplayName("TC-INT-AdminController-012")
    ...
    @Test
    @DisplayName("TC-INT-AdminController-013")
    ...
    @Test
    @DisplayName("TC-INT-AdminController-014")
