...
class GlossarySuggestionServiceTest {
    ...
    void matchTerms_returnsMatchingGlossaryEntries() {
        ...
        List<GlossaryTermSuggestionDTO> suggestions = glossarySuggestionService.matchTerms(
    ...
    void matchTerms_returnsEmptyListForBlankText() {
        ...
        assertThat(glossarySuggestionService.matchTerms("", terms)).isEmpty();
        assertThat(glossarySuggestionService.matchTerms("   ", terms)).isEmpty();
        assertThat(glossarySuggestionService.matchTerms(null, terms)).isEmpty();
    }
